...
<p><strong><a href="#"><?php echo $_G['member']['username'];?></a></strong><span class="xg1"> <a href="#">設置</a></span><span class="pipe">|</span><a href="#">消息</a></p>
<p>積分<span class="pipe">|</span>用戶組</p>
</div>
</div>
<div id="nv">
<ul>
...
<div class="bm_c">
<div class="premsg"><a href="javascript:;" class="xi2">Crossday Discuz! Board</a> 社區系統(簡稱 <stong class="xw1 xi1">Discuz!</stong>)是一個採用 PHP 和 MySQL 等其他多種數據庫構建的高效建站解決方案。</div>
<table class="dt">
<tr>
<td class="xs0">SMALL FONT</td>
<td><a href="javascript:;">鏈接文字</a></td>
<td><a href="javascript:;" class="xi2">高亮鏈接</a></td>
</tr>
<tr>
<td>普通文本</td>
<td class="xg2">中等文本</td>
<td class="xg1">淺色文字</td>
</tr>
<tr class="bw0_all">
<td colspan="3" class="xst">主題列表字體</td>
</tr>
</table>
</div>
</div>
