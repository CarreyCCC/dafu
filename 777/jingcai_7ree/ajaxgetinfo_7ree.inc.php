...
if($_GET['target_7ree']=='race'){
	...
	$racemessage_7ree = DB::result_first("SELECT racemessage_7ree FROM  ".DB::table('jingcai_main_7ree')." WHERE racename_7ree = '$_GET[name_7ree]'");


}elseif($_GET['target_7ree']=='ateam' || $_GET['target_7ree']=='bteam'){

	$teaminfo_7ree = DB::fetch_first("SELECT * FROM  ".DB::table('jingcai_main_7ree')." WHERE aname_7ree = '$_GET[name_7ree]' OR bname_7ree = '$_GET[name_7ree]'");
