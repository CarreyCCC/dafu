...
body {
background:url(template/yunzhan_zq/style/img/fbg.jpg) top center no-repeat;
}
</style>
...
<!--FORUM begain-->
<div class="wp" style="margin-top:330px; margin-bottom:30px; width:100%; height:445px; background: #fff; padding:20px; box-sizing: border-box;">
<div class="ltbanner" style="overflow: hidden;">
<!--[diy=diy4]--><div id="diy4" class="area"></div><!--[/diy]-->
</div>
<div class="gj_rbox" style="overflow: hidden;">
<ul>
<!--[diy=diy5]--><div id="diy5" class="area"></div><!--[/diy]-->
</ul>
</div>
<div class="zq_ad" style="width:1200px; height:100px; background:url(template/yunzhan_zq/style/img/f_ad.jpg); float:left; margin:20px 0 20px -20px;">
</div>
<div class="f_ad_box" style="width:1200px; height:200px; float:left; margin:0 0 20px -20px;">
...
<div class="cl"></div>          
<div id="ct" class="wp cl<?php if($_G['setting']['forumallowside']) { ?> ct2<?php } ?>" style="padding-top:10px;">
<?php if(empty($gid)) { ?>
