...
$url2_7ree = "http://zx.500.com/jclq/kaijiang.php?playid=2&d=".$caijiday_7ree; 
...
$pos_7ree = strpos($info1_7ree,'<div class="an_title">');
...
foreach ($result_7ree as $key => $value){
	if(preg_match("/^([0-9]+):([0-9]+)$/",$value[6])){
			...
			$change_7ree['ashot_7ree'] = $bifen_7ree[1];
			$change_7ree['bshot_7ree'] = $bifen_7ree[0];
