...
0
|| checktplrefresh('./source/plugin/jingcai_7ree/template/jingcai_index_7ree.htm', './template/yunzhan_zq/common/header.htm', 1530509230, 'jingcai_7ree', './data/template/2_jingcai_7ree_jingcai_index_7ree.tpl.php', './source/plugin/jingcai_7ree/template', 'jingcai_index_7ree')
|| checktplrefresh('./source/plugin/jingcai_7ree/template/jingcai_index_7ree.htm', './template/yunzhan_zq/common/footer.htm', 1530509230, 'jingcai_7ree', './data/template/2_jingcai_7ree_jingcai_index_7ree.tpl.php', './source/plugin/jingcai_7ree/template', 'jingcai_index_7ree')
|| checktplrefresh('./source/plugin/jingcai_7ree/template/jingcai_index_7ree.htm', './template/yunzhan_zq/common/header_common.htm', 1530509230, 'jingcai_7ree', './data/template/2_jingcai_7ree_jingcai_index_7ree.tpl.php', './source/plugin/jingcai_7ree/template', 'jingcai_index_7ree')
;?>
...
<div id="yunzhan_topnav" class="nav_bar_box">
 ...
 <?php if($_G['uid']) { ?>
    <div id="yunzhan_user">
      <ul id="yunzhan_nav">
        <li id="user_box"> <span><a href="home.php?mod=space&amp;do=notice" id="myprompt"<?php if($_g['member']['newprompt']) { ?> class="new"<?php } ?>>提醒
  ...
  <span><a href="https://www.aihx888.com/home.php?mod=spacecp&amp;ac=credit&amp;op=buy">充值序號</a></span>
    ...
    <div id="yunzhan_user">
      <ul id="yunzhan_nav">
        <li id="login_u_box"> <span><a id="loginuser" class="username">
          <?php echo dhtmlspecialchars($_G['cookie']['loginuser']); ?>          </a></span> <span><a href="member.php?mod=logging&amp;action=login" onClick="showWindow('login', this.href)">激活</a></span> <span><a href="member.php?mod=logging&amp;action=logout&amp;formhash=<?php echo FORMHASH;?>">退出</a></span><span><a href="https://www.aihx888.com/home.php?mod=spacecp&amp;ac=credit&amp;op=buy">充值序號</a></span> </li>
    ...
    <div id="yunzhan_user">
      <ul id="yunzhan_nav">
        <li id="login_u_box"> <span><a href="home.php?mod=spacecp&amp;ac=usergroup" class="nousername"><?php echo $_G['member']['username'];?></a></span> <span><a href="member.php?mod=logging&amp;action=logout&amp;formhash=<?php echo FORMHASH;?>">退出</a></span><span><a href="https://www.aihx888.com/home.php?mod=spacecp&amp;ac=credit&amp;op=buy">充值序號</a></span> </li>
...
<p style="text-align:center; padding-bottom:30px;">Powered by <strong><a href="https://aihx888.com" target="_blank">神采奕奕</a></strong> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } ?>
<span>&copy; 2001-2018 <a href="https://aihx888.com" target="_blank">Comsenz Inc.</a></span></p>
