...
0
|| checktplrefresh('./template/default/touch/forum/guide.htm', './template/default/touch/forum/guide_list_row.htm', 1530161100, '1', './data/template/1_1_touch_forum_guide.tpl.php', './template/default', 'touch/forum/guide')
;?><?php include template('common/header'); ?><script src="wap.js" type="text/javascript" type="text/javascript"></script>
<!-- header start -->
<header class="header">
<div class="hdc cl">
...
<li class="on"><a href="forum.php?mod=guide&amp;view=hot" class="icon_hotthread">熱帖</a></li>
</ul>
</div>
</header>
<!-- header end -->
...
<h2 class="thread_tit">精彩熱帖</h2><?php if(is_array($data)) foreach($data as $key => $list) { if($list['threadcount']) { ?>
