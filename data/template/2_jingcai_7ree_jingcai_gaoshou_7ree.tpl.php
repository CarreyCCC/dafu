...
<tr class="colplural" >
    ...
    <span class="y">
    <?php echo $race_7ree['aname_7ree'];?> <span style="font-size:13px;color:darkred;font-weight:700;padding:5px;">VS</span> <?php echo $race_7ree['bname_7ree'];?> <span class="pipe">|</span> <?php echo $race_7ree['time_7ree'];?>
    </span>
...
<tr><?php if(is_array($newjingcailist_7ree)) foreach($newjingcailist_7ree as $key_7ree => $newjingcailist_value) { ?>    <td width="50%">
    <div id="gaoshoubox_7ree" class="gaoshoubox_7ree">
    		...
    		<a href="<?php echo $jilu_url_7ree;?><?php echo $newjingcailist_value['uid_7ree'];?>&fenlei2_7ree=<?php echo $race_7ree['fenlei2_7ree'];?>" target="_blank">查看</a>
    		</div>	
    		...
    		<p>季場次:<?php echo $newjingcailist_value['a_changci_7ree'];?> 月場次:<?php echo $newjingcailist_value['m_changci_7ree'];?> 周場次:<?php echo $newjingcailist_value['w_changci_7ree'];?></p>
    		<p>季猜對:<?php echo $newjingcailist_value['a_caidui_7ree'];?> 月猜對:<?php echo $newjingcailist_value['m_caidui_7ree'];?> 周猜對:<?php echo $newjingcailist_value['w_caidui_7ree'];?></p>
    		<!--
    		...
    		-->
    		<p>季命中:<?php echo $newjingcailist_value['a_mingzhong_7ree'];?>% 月命中:<?php echo $newjingcailist_value['m_mingzhong_7ree'];?>% 周命中:<?php echo $newjingcailist_value['w_mingzhong_7ree'];?>%</p>
    		</div>

    </div>
    </td>
    <?php if(($key_7ree+1)%2==0) { ?>
    </tr><tr>
    <?php } } ?>
</tr>
<?php } else { ?>
