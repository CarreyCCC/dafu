...
<div class="bz-header">
	<div class="bz-header-left"><a href="<!--{if $_GET[action] == 'newthread'}-->forum.php?mod=forumdisplay&fid=$_G[fid]&page=$_GET[page]<!--{else}-->forum.php?mod=redirect&goto=findpost&ptid=$_G[tid]&pid=$pid<!--{/if}-->" class="iconfont icon-fanhui1"></a></div>
...
<script type="text/javascript" src="template/banzhuan_touch000/touch/bzcji/ajaxfileupload.js?{VERHASH}"></script>
<script type="text/javascript" src="template/banzhuan_touch000/touch/bzcji/buildfileupload.js?{VERHASH}"></script>
<script type="text/javascript">
