...
0
|| checktplrefresh('./template/default/touch/home/space_pm.htm', './template/default/touch/home/space_pm_node.htm', 1530159285, 'diy', './data/template/1_diy_touch_home_space_pm.tpl.php', './template/default', 'touch/home/space_pm')
;?>
...
<header class="header">
    <div class="nav">
<div class="icon_edit y"><a href="home.php?mod=spacecp&amp;ac=pm"><span class="none">發消息</span></a></div>
...
<span class="name">我對 <?php echo $value['tousername'];?>說:</span>
<?php } else { ?>
<span class="name"><?php echo $value['tousername'];?> 對我說:</span>
<?php } } elseif($value['pmtype'] == 2) { ?>
<span class="name">發起者:<?php echo $value['firstauthor'];?></span>
<?php } ?>
</div>
<div class="cl grey">
...
<div class="reply b_m"><input type="button" name="pmsubmit" id="pmsubmit" class="formdialog button2" value="回復" /></div>
            </form>
...
<?php } } else { ?>
<div class="bm_c">
手機版不支持複雜短消息操作，請返回<a href="home.php?mod=space&amp;do=pm&amp;filter=privatepm">我的短消息</a>
</div>
