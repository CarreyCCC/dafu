...
<ul>
<li>留言給:</li>
<li><label><input type="checkbox" name="newaccess[1]" class="pc" value="1" checked="checked" disabled="disabled" />論壇管理員</label></li>
<li><label><input type="checkbox" name="newaccess[2]" class="pc" value="1" checked="checked" />超級版主</label></li>
...
<?php } ?>
<div class="um bw0 cl">
<input type="checkbox" name="ncheck" id="ncheck" class="pc" onclick="checkall($('notelist'), 'delete', 'ncheck')" /> <label for="ncheck">全選</label>
<button type="submit" name="submit" id="submit" class="pn" value="true"><strong>刪除</strong></button>
</div>
</form>
<?php } else { ?>
<p class="emp">當前沒有人留言</p>
<?php } ?>
</div>