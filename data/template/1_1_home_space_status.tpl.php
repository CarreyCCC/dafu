...
<?php if($space['spacenote']) { ?><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=doing&amp;view=me" title="查看我的所有記錄" class="xi2"><?php echo $space['spacenote'];?></a><?php } else { ?><label for="mood_message" class="xi2">您還沒有更新過心情記錄</label><?php } ?>
</div>
...
$('mood_mystatus').innerHTML = '<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=doing&amp;view=me" title="查看我的所有記錄" class="xi2">'+s+'</a>';
});
$('mood_message').value = '';
...
<td class="moodfm_btn">
<button type="submit" name="addsubmit_btn" id="addsubmit_btn">發佈</Button>
</td>
</tr>
<tr>
<td class="moodfm_f">
...
<a title="同步到個人簽名" id="syn_signature" class="syn_signature" href="javascript:void(0);" onclick="checkSynSignature()">同步到個人簽名</a>
...
<label for="to_sign"><input type="checkbox" name="to_signhtml" id="to_sign" class="pc" value="1" />同步到個人簽名</label>
<?php } } ?>
