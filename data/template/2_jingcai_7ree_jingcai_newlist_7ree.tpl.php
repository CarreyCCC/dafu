...
<tr class="colplural" >
    <th colspan="6">
    <span class="y">
    共<?php echo $num_7ree['num_7ree'];?>人支持
    <?php if($race_7ree['win_7ree'] || $jingcai_7ree_var['showext_7ree']) { ?>
    <span class="pipe">|</span>
    <?php echo $num_7ree['odds_7ree'];?><?php echo $exttitle_7ree;?>
    <?php } ?>
    </span>
    <h3>最新競猜榜</h3>
    </th>
...
<td align="center">
<?php if($race_7ree['win_7ree'] || $jingcai_7ree_var['showext_7ree']) { ?>
<?php echo $newjingcailist_value['myodds_7ree'];?><?php echo $exttitle_7ree;?><span class="pipe">|</span>
<?php if($newjingcailist_value['mywin_7ree']=="d") { ?>已返還<?php } else { ?><?php echo $newjingcailist_value['log_reward_7ree'];?><?php echo $exttitle_7ree;?><?php } ?>
        <?php } else { ?>
        <span title="賽事揭曉後顯示" style="color:gray;">已隱藏</span>
<?php } ?>
</td>
