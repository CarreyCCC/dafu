...
<?php if($a == 'ls') { ?>
	...
	<div class="container">
		...
		<div class="hastabmenu" style="height:218px;">
			<ul class="tabmenu">
				<li id="addadmin" class="tabcurrent"><a href="#" onclick="switchbtn('addadmin');">添加UCenter管理員</a></li>
				<?php if($user['isfounder']) { ?><li id="editpw"><a href="#" onclick="switchbtn('editpw');">修改UCenter創始人密碼</a></li><?php } ?>
			</ul>
			...
			<div id="editpwdiv" class="tabcontent" style="display:none;">
				<p class="i">此處密碼僅為UCenter後台創始人登陸密碼，與各應用管理員密碼無關更不會自動同步更改，請務必妥善保存此密碼</p>
