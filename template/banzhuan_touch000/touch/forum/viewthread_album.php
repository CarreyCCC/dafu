...
<style type="text/css">
.postalbum { background-color: #000; display: none; height: 100%; overflow: hidden; padding: 0 0 1px 0; position: absolute; top: 0; width: 100%; z-index: 80; }
.postalbum_h { width: 100%; height: 40px; position: fixed; top: 0; z-index: 99; background-color: #000; }
.postalbum_h h2 { width: 56%; float: left; text-align: center; font-size: 14px; color: #FFF; line-height: 40px; font-weight: 100; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
.postalbum_h_l { width: 22%; float: left; line-height: 40px; }
.postalbum_h_l a { color: #FFF; line-height: 40px; font-size: 16px; margin-left: 10px; float: left; }
.postalbum_h_r { width: 22%; float: right; line-height: 40px; }
.postalbum_h_r a { color: #FFF; line-height: 40px; margin-right: 10px; float: right; }
.postalbum_h_l em, .postalbum_h_r em { font-size: 12px; }
...
.postalbum_i { margin-bottom: -3px; max-width: 100%; vertical-align: middle; visibility: hidden; }
	...
	<div class="postalbum">
		<div class="postalbum_h">
			<div class="postalbum_h_l"><a href="javascript:history.back();" class="iconfont icon-fanhui1"></a></div>	
			<h2>{lang numheader}<span id="curpic"> <!--{eval echo $curaidkey + 1}--> </span>{lang unitpaper} / {lang numtotal} $count {lang unitpaper}</h2>
		    <div class="postalbum_h_r"><a href="forum.php" class="iconfont icon-home-o"></a></div>
		</div>
