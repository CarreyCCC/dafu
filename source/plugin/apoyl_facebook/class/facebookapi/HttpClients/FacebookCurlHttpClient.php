...
require FACEBOOK_SDK_V4_SRC_DIR.'Http/GraphRawResponse.php';
require FACEBOOK_SDK_V4_SRC_DIR.'HttpClients/FacebookHttpClientInterface.php';
require 'FacebookCurl.php';
