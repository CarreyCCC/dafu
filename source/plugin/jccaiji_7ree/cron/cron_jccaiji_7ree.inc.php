...
foreach ($result_7ree as $key => $value){
	...
	if($key>0){
			...
			if(!$jump1_7ree && !$jump2_7ree){
					...
					$change_7ree['ping_7ree'] = $vars_7ree['peilv_7ree'] ?  floatval($change_7ree['peilv_7ree'][1]) : $vars_7ree['peilv_ping_7ree'];
					$change_7ree['zhufu_7ree'] = $vars_7ree['peilv_7ree'] ?  floatval($change_7ree['peilv_7ree'][2]) : $vars_7ree['peilv_ke_7ree'];
