 ...
 *
 */
//@liyuanchao 2018-01 mod http://www.apoyl.com/
...
class RandomBytesPseudoRandomStringGenerator implements PseudoRandomStringGeneratorInterface
{
   // use PseudoRandomStringGeneratorTrait;
    ...
    {
     	$this->trait=new PseudoRandomStringGeneratorTrait();
    ...
    {
        $this->trait->validateLength($length);

        return $this->trait->binToHex(random_bytes($length), $length);
    }
}
