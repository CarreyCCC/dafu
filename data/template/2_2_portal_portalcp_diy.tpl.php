...
<dt class="cl pns">
<div class="y">
<button type="button" id="uploadmsg_button" onclick="Util.toggleEle('upload');" class="pn pnc z<?php if(empty($list)) { ?> hide<?php } ?>"><span>上傳新圖片</span></button>
...
<button type="submit" name="uploadsubmit" id="btnupload" class="pn" value="true"><span>開始上傳</span></button>
</form>
</div>
...
<span class="pipe">|</span><a id="diy_tag_blocktitle" href="javascript:;" onclick="spaceDiy.setCurrentDiy('blocktitle');return false;">標題欄</a></span>
<span class="pipe">|</span><a id="diy_tag_ct" href="javascript:;" onclick="spaceDiy.setCurrentDiy('ct');return false;">內容區</a>

  	<a style="margin-left: 40px;" id="bg_button" href="javascript:;" onclick="spaceDiy.hideBg();return false;">取消背景圖</a>
<span class="pipe">|</span><a id="recover_button" href="javascript:;" onclick="spaceDiy.recoverStyle();return false;">恢復原裝皮膚</a>
</dt>
<dd>
...
<div class="z cur1" onclick="spaceDiy.changeBgImgDiv();">更換</div></center>
</div>
...
<tr>
<td><label for="repeat_mode">圖片平舖:</label></td>
<td>
<select id="repeat_mode" name="repeat_mode" class="ps" onclick="spaceDiy.setBgRepeat(this.value);">
<option value="0" selected="selected">平舖</option>
<option value="1">直接使用</option>
<option value="2">橫向平舖</option>
<option value="3">縱向平舖</option>
</select>
</td>
</tr>
<tr>
...
<td>背景滾動:</td>
<td>
<label for="rabga0"><input type="radio" id="rabga0" name="attachment_mode" onclick="spaceDiy.setBgAttachment(0);" class="pr" />滾動</label>
...
<h3 class="flb">
<em id="return_<?php echo $_GET['handlekey'];?>">導入框架</em>
<span>
<?php if($_G['inajax']) { ?><a href="javascript:;" class="flbc" onclick="hideWindow('<?php echo $_GET['handlekey'];?>');return false;" title="關閉">關閉</a><?php } ?>
</span>
</h3>
<ul class="tb cl">
<li<?php if(empty($_GET['type'])) { ?> class="a"<?php } ?> id="li_import_upload"><a onclick="showWindow('showimport', this.getAttribute('href'));" href="portal.php?mod=portalcp&amp;ac=diy&amp;op=import&amp;type=0&amp;tpl=<?php echo $_GET['tpl'];?>">上傳文件</a></li>
<li<?php if($_GET['type'] == 1) { ?> class="a"<?php } ?> id="li_import_system"><a onclick="showWindow('showimport', this.getAttribute('href'));" href="portal.php?mod=portalcp&amp;ac=diy&amp;op=import&amp;type=1&amp;tpl=<?php echo $_GET['tpl'];?>">系統內置</a></li>
</ul>
...
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<button type="submit" class="pn pnc" id="frameimportbutton"><strong>導入</strong></button>
</div>
</form>
