 ...
 *
 */
//@liyuanchao 2018-01 mod
if(!defined('IN_DISCUZ')){
    exit("Access Denied");
}
require FACEBOOK_SDK_V4_SRC_DIR.'GraphNodes/Collection.php';
require FACEBOOK_SDK_V4_SRC_DIR.'GraphNodes/GraphNode.php';
require FACEBOOK_SDK_V4_SRC_DIR.'Helpers/FacebookSignedRequestFromInputHelper.php';
require FACEBOOK_SDK_V4_SRC_DIR.'Authentication/AccessToken.php';
require FACEBOOK_SDK_V4_SRC_DIR.'Authentication/OAuth2Client.php';
require FACEBOOK_SDK_V4_SRC_DIR.'FileUpload/FacebookFile.php';
require FACEBOOK_SDK_V4_SRC_DIR.'FileUpload/FacebookResumableUploader.php';
require FACEBOOK_SDK_V4_SRC_DIR.'FileUpload/FacebookTransferChunk.php';
require FACEBOOK_SDK_V4_SRC_DIR.'FileUpload/FacebookVideo.php';
require FACEBOOK_SDK_V4_SRC_DIR.'GraphNodes/GraphEdge.php';
require FACEBOOK_SDK_V4_SRC_DIR.'Url/UrlDetectionInterface.php';
require FACEBOOK_SDK_V4_SRC_DIR.'Url/FacebookUrlDetectionHandler.php';
require FACEBOOK_SDK_V4_SRC_DIR.'PseudoRandomString/PseudoRandomStringGeneratorInterface.php';
require FACEBOOK_SDK_V4_SRC_DIR.'PseudoRandomString/PseudoRandomStringGeneratorFactory.php';
require FACEBOOK_SDK_V4_SRC_DIR.'HttpClients/HttpClientsFactory.php';
require FACEBOOK_SDK_V4_SRC_DIR.'HttpClients/FacebookStream.php';
require FACEBOOK_SDK_V4_SRC_DIR.'PersistentData/PersistentDataInterface.php';
require FACEBOOK_SDK_V4_SRC_DIR.'PersistentData/PersistentDataFactory.php';
require FACEBOOK_SDK_V4_SRC_DIR.'Helpers/FacebookCanvasHelper.php';
require FACEBOOK_SDK_V4_SRC_DIR.'Helpers/FacebookJavaScriptHelper.php';
require FACEBOOK_SDK_V4_SRC_DIR.'Helpers/FacebookPageTabHelper.php';
require FACEBOOK_SDK_V4_SRC_DIR.'Helpers/FacebookRedirectLoginHelper.php';
require FACEBOOK_SDK_V4_SRC_DIR.'Exceptions/FacebookSDKException.php';
require FACEBOOK_SDK_V4_SRC_DIR.'Exceptions/FacebookServerException.php';

require FACEBOOK_SDK_V4_SRC_DIR.'Exceptions/FacebookAuthenticationException.php';
