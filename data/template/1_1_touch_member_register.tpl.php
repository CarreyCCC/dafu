...
0
|| checktplrefresh('./template/default/touch/member/register.htm', './template/default/touch/common/seccheck.htm', 1529677463, '1', './data/template/1_1_touch_member_register.tpl.php', './template/default', 'touch/member/register')
...
<input type="text" class="txt px vm" style="ime-mode:disabled;width:115px;background:white;" autocomplete="off" value="" id="seccodeverify_<?php echo $sechash;?>" name="seccodeverify" placeholder="驗證碼" fwin="seccode">
