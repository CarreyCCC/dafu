...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1530511374, '2', './data/template/2_2_member_login.tpl.php', './template/yunzhan_zq', 'member/login')
...
<td>
<?php if($this->setting['sitemessage']['login'] && empty($_GET['infloat'])) { ?><a href="javascript:;" id="custominfo_login_<?php echo $loginhash;?>" class="y">&nbsp;<img src="<?php echo IMGDIR;?>/info_small.gif" alt="幫助" class="vm" /></a><?php } ?>								
</td>
</tr>
</table>
</div>
