 ...
 *
 */
//@liyuanchao 2016-11 mod http://www.apoyl.com/
if(!defined('IN_DISCUZ')){
    exit("Access Denied");
}
require FACEBOOK_SDK_V4_SRC_DIR.'PseudoRandomString/RandomBytesPseudoRandomStringGenerator.php';
require FACEBOOK_SDK_V4_SRC_DIR.'PseudoRandomString/PseudoRandomStringGeneratorTrait.php';
require FACEBOOK_SDK_V4_SRC_DIR.'PseudoRandomString/McryptPseudoRandomStringGenerator.php';
require FACEBOOK_SDK_V4_SRC_DIR.'PseudoRandomString/OpenSslPseudoRandomStringGenerator.php';
require FACEBOOK_SDK_V4_SRC_DIR.'PseudoRandomString/UrandomPseudoRandomStringGenerator.php';
